...
def get_codebase_structure(base_dir: str = "frontend/src") -> str:
    ...
    structure = []
    structure.append("# Current Frontend Structure\n\n")
...
async def plan_architecture(client, component_spec: Dict) -> Dict:
    """
    ...
    try:
        ...
        try:
            ...
            print("✅ Extracted architecture plan")
...
async def main():
    ...
    try:
        plan = await plan_architecture(client, component_spec)
    finally:
        await client.close()
